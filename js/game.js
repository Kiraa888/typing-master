...
import { elements, setupVisualKeyboard, updateHeatmap, updateCursorAndTarget, renderPerformanceChart } from './ui.js';
...
function startTimer() {
    ...
    gameState.timerInterval = setInterval(() => {
        ...
        if (currentSecond > gameState.lastSecond) {
            const currentWPM = parseInt(elements.wpmElem.innerText) || 0;
            gameState.history.labels.push(currentSecond);
            gameState.history.wpm.push(currentWPM);
            gameState.history.errors.push(gameState.errorsThisSecond > 0 ? gameState.errorsThisSecond : null);
            
            gameState.errorsThisSecond = 0;
            gameState.lastSecond = currentSecond;
        }
...
function endGame() {
    ...
    renderPerformanceChart(gameState.history);
